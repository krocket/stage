...
class CustomerPortal(CustomerPortal):
    ...
    def my_nursery_orders(self, page=1, date_begin=None, date_end=None, sortby=None, search=None, search_in='content',
                          **kw):
        ...
        orders = request.env['nursery.order'].search(domain, order=order, limit=self._items_per_page,
                                                     offset=pager['offset'])
